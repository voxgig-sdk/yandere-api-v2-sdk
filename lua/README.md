...
The Lua SDK for the YandereApiV2 API. Provides an entity-oriented interface using Lua conventions.
...
```lua
local result, err = client:Post(nil):list(nil, nil)
...
local result, err = client:YandereApiV2(nil):load(
  { id = "test01" }, nil
)
