...
describe("PostDirect", function()
  it("should direct-list-post", function()
    local setup = post_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-post", setup.live and "live" or "unit")
...
function post_direct_setup(mockres)
