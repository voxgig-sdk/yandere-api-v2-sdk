...
// YandereApiV2 SDK utility type

class YandereApiV2Utility
{
    ...
    public static function copy(YandereApiV2Utility $src): YandereApiV2Utility
    {
        $u = new YandereApiV2Utility();
        $u->clean = $src->clean;
        $u->done = $src->done;
