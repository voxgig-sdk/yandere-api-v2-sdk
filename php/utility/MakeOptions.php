...
// YandereApiV2 SDK utility: make_options

class YandereApiV2MakeOptions
{
    ...
    public static function call(YandereApiV2Context $ctx): array
    {
        ...
        //
        // `YandereApiV2Schema::optspec()` is built from the model:
        ...
        $optspec = YandereApiV2Schema::optspec();
