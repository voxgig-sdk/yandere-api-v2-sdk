...
// YandereApiV2 SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class YandereApiV2MakeRequest
{
    public static function call(YandereApiV2Context $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new YandereApiV2Response(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new YandereApiV2Response($fetched);
        } else {
