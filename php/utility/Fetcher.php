...
// YandereApiV2 SDK utility: fetcher

class YandereApiV2Fetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; YandereApiV2SDK/1.0)';
    ...
    public static function call(YandereApiV2Context $ctx, string $fullurl, array $fetchdef): array
    {
