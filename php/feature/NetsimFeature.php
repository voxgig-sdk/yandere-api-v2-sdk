...
// YandereApiV2 SDK netsim feature
...
class YandereApiV2NetsimFeature extends YandereApiV2BaseFeature
{
    ...
    private function _simulate(YandereApiV2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(YandereApiV2Context $ctx, array $applied): void
    {
        $client = $this->client;
