...
// YandereApiV2 SDK timeout feature
...
class YandereApiV2TimeoutFeature extends YandereApiV2BaseFeature
{
    ...
    private function _with_timeout(YandereApiV2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(YandereApiV2Context $_ctx, float $ms): void
    {
        $client = $this->client;
