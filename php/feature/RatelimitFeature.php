...
// YandereApiV2 SDK ratelimit feature
...
class YandereApiV2RatelimitFeature extends YandereApiV2BaseFeature
{
    ...
    private function _acquire(YandereApiV2Context $ctx): void
    {
    ...
    private function _track(YandereApiV2Context $_ctx, float $wait_ms): void
    {
        $client = $this->client;
