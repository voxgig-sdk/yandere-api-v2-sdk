...
// YandereApiV2 SDK streaming feature
...
class YandereApiV2StreamingFeature extends YandereApiV2BaseFeature
{
    ...
    private function _iterate(YandereApiV2Result $result): \Generator
    {
    ...
    private function _streamable(YandereApiV2Context $ctx): bool
    {
