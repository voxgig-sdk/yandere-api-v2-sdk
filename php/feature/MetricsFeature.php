...
// YandereApiV2 SDK metrics feature
...
class YandereApiV2MetricsFeature extends YandereApiV2BaseFeature
{
    ...
    private function _record(YandereApiV2Context $ctx, bool $ok): void
    {
