...
// YandereApiV2 SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (YandereApiV2SDK::test)
...
{
    private const SDK_CLASS = 'YandereApiV2SDK';
    ...
    private const SDK_BASE = 'yandereapiv2_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../yandereapiv2_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
