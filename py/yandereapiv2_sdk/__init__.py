...
from yandereapiv2_sdk.utility import register

# Load features
from yandereapiv2_sdk.feature.base_feature import YandereApiV2BaseFeature
from yandereapiv2_sdk.features import _has_feature, _make_feature
...
class YandereApiV2SDK:
    ...
    def get_utility(self):
        return YandereApiV2Utility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("YandereApiV2SDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Post(self, data=None) -> "PostEntity":
        ...
        from yandereapiv2_sdk.entity.post_entity import PostEntity
