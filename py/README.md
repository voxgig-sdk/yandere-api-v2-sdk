...
The Python SDK for the YandereApiV2 API. Provides an entity-oriented interface following Pythonic conventions.
...
```python
result, err = client.Post(None).list(None, None)
if err:
    raise Exception(err)
...
result, err = client.YandereApiV2(None).load(
    {"id": "test01"}, None
)
