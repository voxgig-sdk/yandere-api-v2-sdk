...
class YandereApiV2TestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = YandereApiV2TestRunner.getenv("YANDERE_API_V2_TEST_LIVE")
        override = YandereApiV2TestRunner.getenv("YANDERE_API_V2_TEST_OVERRIDE")
        ...
        explain = YandereApiV2TestRunner.getenv("YANDERE_API_V2_TEST_EXPLAIN")
...
def entity_data(v):
    return YandereApiV2TestRunner.entity_data(v)
...
def live_client_options():
    return YandereApiV2TestRunner.live_client_options()
