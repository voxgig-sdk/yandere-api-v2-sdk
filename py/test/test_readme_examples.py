# YandereApiV2 SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions YandereApiV2SDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both YandereApiV2SDK(...) and YandereApiV2SDK.test(...) become
#      YandereApiV2SDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "yandereapiv2_sdk"
_SDK_CLASS = "YandereApiV2SDK"
