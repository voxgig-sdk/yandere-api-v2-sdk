...
import { YandereApiV2SDK, BaseFeature, stdutil } from '../../..'
...
function basicSetup(extra?: any) {
  ...
  let client = YandereApiV2SDK.test(options, extra)
