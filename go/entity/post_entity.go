...
func NewPostEntity(client *core.YandereApiV2SDK, entopts map[string]any) *PostEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PostEntity) GetName() string { return e.name }
...
func (e *PostEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PostEntity) Deleted() bool {
	return e.deleted
}


func (e *PostEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPostEntity(e.client, opts)
}

func (e *PostEntity) Data(args ...any) any {
...
func (e *PostEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Post; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PostEntity) DataTyped(data ...Post) Post {
	if len(data) > 0 {
		return typedFrom[Post](e.Data(asMap(data[0])))
	}
	return typedFrom[Post](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Post (all fields
// optional at the wire level).
func (e *PostEntity) MatchTyped(match ...Post) Post {
	if len(match) > 0 {
		return typedFrom[Post](e.Match(asMap(match[0])))
	}
	return typedFrom[Post](e.Match())
}
...
func (e *PostEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PostEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *PostEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PostListMatch and returns []Post. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PostEntity) ListTyped(reqmatch PostListMatch, ctrl map[string]any) ([]Post, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Post](res), nil
}



func (e *PostEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PostEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PostEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PostEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
