...
func (sdk *YandereApiV2SDK) OptionsMap() map[string]any {
...
func (sdk *YandereApiV2SDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *YandereApiV2SDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *YandereApiV2SDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *YandereApiV2SDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *YandereApiV2SDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *YandereApiV2SDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("YandereApiV2SDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *YandereApiV2SDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *YandereApiV2SDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("YandereApiV2SDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *YandereApiV2SDK {
	...
	sdk := NewYandereApiV2SDK(sdkopts)
	sdk.Mode = "test"
