...
## Install
```bash
go get github.com/voxgig-sdk/yandere-api-v2-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/yandere-api-v2-sdk=../path/to/github.com/voxgig-sdk/yandere-api-v2-sdk
```
...
```
github.com/voxgig-sdk/yandere-api-v2-sdk/
...
The root package (`github.com/voxgig-sdk/yandere-api-v2-sdk`) re-exports everything needed
