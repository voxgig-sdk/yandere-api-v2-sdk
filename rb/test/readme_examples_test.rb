...
#      offline in seeded test mode (YandereApiV2SDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "YandereApiV2_sdk.rb")
  SDK_CLASS = "YandereApiV2SDK"
