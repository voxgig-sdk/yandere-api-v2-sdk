...
class PostEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set YANDERE_API_V2_TEST_POST_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def post_basic_setup(extra)
  ...
  entid_env_raw = ENV["YANDERE_API_V2_TEST_POST_ENTID"]
