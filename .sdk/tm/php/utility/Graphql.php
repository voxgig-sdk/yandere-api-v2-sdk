...
// YandereApiV2 SDK utility: graphql
//
...
class YandereApiV2Graphql
{
    ...
    // equivalent.
    public static function body(YandereApiV2Context $ctx): mixed
    {
    ...
    public static function errors(YandereApiV2Context $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
