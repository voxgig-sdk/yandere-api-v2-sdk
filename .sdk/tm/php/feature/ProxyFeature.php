...
// YandereApiV2 SDK proxy feature
...
class YandereApiV2ProxyFeature extends YandereApiV2BaseFeature
{
    ...
    public function init(YandereApiV2Context $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (YandereApiV2Context $ctx2, string $url2, array $fetchdef) use ($inner): array {
