...
// YandereApiV2 SDK audit feature
...
class YandereApiV2AuditFeature extends YandereApiV2BaseFeature
{
    ...
    private function _emit(YandereApiV2Context $ctx, string $outcome): void
    {
