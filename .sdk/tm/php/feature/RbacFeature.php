...
class YandereApiV2RbacFeature extends YandereApiV2BaseFeature
{
    ...
    private function _required(YandereApiV2Context $ctx): ?string
    {
    ...
    private function _reject(YandereApiV2Context $ctx, string $required): void
    {
    ...
    private function _track(YandereApiV2Context $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
