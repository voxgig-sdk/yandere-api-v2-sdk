...
// YandereApiV2 SDK cache feature
...
class YandereApiV2CacheFeature extends YandereApiV2BaseFeature
{
    ...
    private function _through(YandereApiV2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
