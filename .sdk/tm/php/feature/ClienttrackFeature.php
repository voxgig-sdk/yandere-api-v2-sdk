...
// YandereApiV2 SDK clienttrack feature
...
class YandereApiV2ClienttrackFeature extends YandereApiV2BaseFeature
{
    ...
    public function PostConstruct(YandereApiV2Context $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'YandereApiV2-SDK';
