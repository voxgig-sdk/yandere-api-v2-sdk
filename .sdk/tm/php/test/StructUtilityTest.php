...
// YandereApiV2 SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = YandereApiV2Omni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(YandereApiV2Omni::structfix($now, Struct::undef()))
                        !== json_encode(YandereApiV2Omni::structfix($val, Struct::undef()))) {
