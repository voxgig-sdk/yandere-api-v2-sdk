...
from projectname_sdk import YandereApiV2SDK
from projectname_sdk.core.spec import YandereApiV2Spec
from projectname_sdk.core.result import YandereApiV2Result
from projectname_sdk.core.response import YandereApiV2Response
from projectname_sdk.core.operation import YandereApiV2Operation
from projectname_sdk.core.error import YandereApiV2Error
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import YandereApiV2BaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return YandereApiV2Error(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = YandereApiV2SDK.test(None, None)
        ...
        class TestInitFeature(YandereApiV2BaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(YandereApiV2BaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_fetcher_blocked_test_mode(self):
        ...
        blocked_client = YandereApiV2SDK({
            "base": "http://localhost:8080",
            "system": {
                "fetch": mock_fetch,
            },
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = YandereApiV2Spec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = YandereApiV2SDK.test(None, setup_opts)
    ...
    def test_operator_basic(self):
        ...
        def subject(entry):
            ...
            if not isinstance(in_val, dict):
                in_val = {}
            op = YandereApiV2Operation(in_val)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = YandereApiV2SDK.test(None, setup_opts)
