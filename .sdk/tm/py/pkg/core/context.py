...
from projectname_sdk.core.control import YandereApiV2Control
...
class YandereApiV2Context:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, YandereApiV2Spec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, YandereApiV2Result):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, YandereApiV2Response):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return YandereApiV2Error(code, msg, self)
