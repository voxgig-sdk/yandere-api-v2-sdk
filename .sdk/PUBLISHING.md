...
|---|---|---|
| `ts/` | @voxgig-sdk/yandere-api-v2-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/yandere-api-v2-sdk \
      --repository voxgig-sdk/yandere-api-v2-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/yandere-api-v2-sdk` shows it, and
`npm trust revoke @voxgig-sdk/yandere-api-v2-sdk --id=<id>` removes it.
