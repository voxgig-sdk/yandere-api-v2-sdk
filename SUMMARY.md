...
Results: Successful response with post data.
...
| --- | --- | --- | --- |
| Post | `list` | `GET /post.json` | See reference |

## Connect to the API

- Yande.re production server: `https://yande.re`
...
- `yandere-api-v2_list`: List records for an entity. Supported entities: `post`.
- `yandere-api-v2_load`: Load one record for an entity. No active entity supports this operation.
