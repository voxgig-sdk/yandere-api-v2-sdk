...
func registerSDKWords(r *eng.Registry, client *sdk.YandereApiV2SDK) {
...
func runOp(client *sdk.YandereApiV2SDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
