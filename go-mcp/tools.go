...
type Args struct {
	Entity string         `json:"entity" jsonschema:"post"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.YandereApiV2SDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "yandere-api-v2_list",
		Description: "List records from YandereApiV2. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "yandere-api-v2_load",
		Description: "Load a single record from YandereApiV2. " +
...
func runOp(client *sdk.YandereApiV2SDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.YandereApiV2SDK, name string) (sdk.YandereApiV2Entity, error) {
