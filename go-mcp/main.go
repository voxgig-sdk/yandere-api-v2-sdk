// Command YandereApiV2-mcp is an MCP server exposing the YandereApiV2
// SDK as MCP tools.
//
// Two tools are registered:
//
//	YandereApiV2_list  — list records of an entity
//	YandereApiV2_load  — load a single record of an entity
//
